          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {products.data.map((p: Product) => {
              ...
              return (
                <div
                  key={p.id}
                  className="border rounded-lg p-4 flex flex-col h-full group relative hover:shadow-md transition-shadow"
                >
                  <Link href={`/admin/products/${p.id}/edit`} className="flex-1 flex flex-col">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-2 mb-1">
                        {p.sale_price ? (
                          <>
                            <span className="text-red-600 font-semibold">UGX {p.sale_price}</span>
                            <span className="text-gray-500 line-through text-sm">UGX {p.price}</span>
                          </>
                        ) : (
                      ...
                      <div className="text-sm font-medium mb-1">
                        ...
                        <span
                          className={`${
                            p.stock_quantity > 0 ? "text-green-600" : "text-red-600"
                          }`}
                        >
                          {p.stock_quantity}
                        </span>
